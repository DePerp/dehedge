import { processNewPrice } from '../lib/controller.js'
...
export function setPrice(params) {
	...
	// check current price sink for this source. if placeted timestamp is older than current one, don't update it (no timestamp update)
